...
export default function OrderDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 backdrop-blur-sm">
              ...
              <div className="space-y-3 sm:space-y-4">
                {order.items.map((item) => (
                  <div
                    key={item.id}
                    className="flex justify-between items-center py-3 sm:py-4 border-b border-white/5 last:border-0 gap-3"
                  >
                    ...
                    <p className="font-medium shrink-0 text-sm sm:text-base">
            ...
            {order.aiRecommendation && <AIRecommendationSummary ai={order.aiRecommendation} />}
      ...
      <InvoiceModal order={order} isOpen={isInvoiceOpen} onClose={() => setIsInvoiceOpen(false)} />
    </div>
  );
}
